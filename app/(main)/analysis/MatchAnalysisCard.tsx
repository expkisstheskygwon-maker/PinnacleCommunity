          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {predictions.map((pred, i) => (
              <div key={i} className="bg-white/5 border border-white/5 rounded-xl p-3 flex flex-col gap-3 group relative overflow-hidden">
                {/* Background flare based on winRate */}
                {pred.winRate > 60 && (
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="flex items-center gap-1 bg-white/5 hover:bg-primary/20 hover:text-primary transition-colors text-xs font-bold px-3 py-1.5 rounded-lg border border-white/5 shrink-0">
