...
const CATEGORIES = [
  ...
  { id: "auth", label: "가입/인증", icon: UserPlus },
  { id: "payment", label: "결제/입출금", icon: CreditCard },
  { id: "odds", label: "배당/정산", icon: BarChart3 },
  { id: "security", label: "계정/보안", icon: Shield },
];

const FAQ_ITEMS = [
  { id: 1, question: "피나클은 한국에서 합법인가요?", answer: "피나클은 큐라소 라이선스를 보유한 해외 합법 사이트입니다. 한국 국내법상 해외 베팅 사이트 이용에 대한 법적 판단은 변호사와 상담하시기 바랍니다.", category: "auth" },
  { id: 2, question: "입금은 어떤 방법으로 하나요?", answer: "암호화폐(비트코인, 이더리움 등), Skrill, Neteller 등의 결제 수단을 지원합니다. 국내 은행 직접 이체는 지원되지 않습니다.", category: "payment" },
  { id: 3, question: "배당 제한(limit)을 받을 수 있나요?", answer: "피나클은 '위너 환영(Winners Welcome)' 정책으로 유명하며, 타 사이트 대비 배당 제한이 거의 없습니다. 다만 극단적인 아비트라지 행위 등은 제한될 수 있습니다.", category: "odds" },
  { id: 4, question: "2FA(이중인증) 설정은 어떻게 하나요?", answer: "마이 계정 > 보안 설정에서 Google Authenticator 또는 Authy 앱을 연동할 수 있습니다. 설정 시 백업 코드를 반드시 저장해 두세요.", category: "security" },
];

const USER_QUESTIONS = [
  { id: 1, question: "피나클 가입 시 VPN이 필요한가요?", author: "뉴비질문", date: "2026-04-20", answers: 12, solved: true, category: "auth", views: 345, topAnswer: "가입 시에는 VPN 없이도 가능하지만, 접속 지역에 따라 필요할 수 있습니다. 일반적으로 Chrome 확장 프로그램 형태의 VPN이면 충분합니다." },
  { id: 2, question: "출금 신청 후 48시간 넘게 처리 안 됩니다", author: "출금대기", date: "2026-04-19", answers: 8, solved: false, category: "payment", views: 234, topAnswer: "" },
  { id: 3, question: "아시안핸디캡 정산 기준이 궁금합니다", author: "핸디초보", date: "2026-04-18", answers: 15, solved: true, category: "odds", views: 567, topAnswer: "아시안핸디캡은 경기 결과에 핸디캡을 적용한 후 승패를 판단합니다. 예를 들어 -0.5는 해당 팀이 1골 이상 이겨야 당첨됩니다." },
  { id: 4, question: "계정 잠김 해결 방법", author: "계정잠김", date: "2026-04-17", answers: 6, solved: true, category: "security", views: 189, topAnswer: "연속 로그인 실패 시 자동 잠김됩니다. 라이브 채팅으로 본인 확인 후 해제 가능합니다." },
  { id: 5, question: "최소 입금 금액이 얼마인가요?", author: "첫입금", date: "2026-04-16", answers: 9, solved: true, category: "payment", views: 412, topAnswer: "암호화폐의 경우 최소 약 10 USD 상당이며, 결제 수단에 따라 다릅니다." },
  { id: 6, question: "피나클 정산이 다른 사이트보다 느린 이유?", author: "정산궁금", date: "2026-04-15", answers: 11, solved: true, category: "odds", views: 298, topAnswer: "피나클은 공식 리그 데이터를 기준으로 정산하므로 약간의 지연이 있을 수 있으나, 통상 30분 이내 처리됩니다." },
];
