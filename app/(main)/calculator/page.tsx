...
import { 
  Calculator, Trash2, ArrowRightLeft, Percent, 
  HelpCircle, ChevronRight, Info, AlertTriangle, ShieldCheck
} from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-10 max-w-5xl">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <h1 className="text-2xl md:text-4xl font-black tracking-tighter mb-3">
            배당 및 <span className="text-primary italic">마진율 계산기</span>
          </h1>
          <p className="text-muted-foreground text-sm leading-relaxed">
            북메이커가 책정한 배당률에 포함된 숨겨진 수수료(마진)를 분석하고, 
            수수료가 제거된 실제 통계적 &apos;공정 확률&apos;을 즉시 계산합니다.
          </p>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="glass-card-hover rounded-2xl p-5 flex items-start gap-4 cursor-pointer group">
              ...
              <div>
                <h4 className="font-bold text-sm text-foreground mb-1 group-hover:text-primary transition-colors flex items-center gap-1">
                  차익 거래 (양방) 계산기 <ChevronRight className="w-3.5 h-3.5 opacity-0 group-hover:opacity-100 transition-all" />
                </h4>
                <p className="text-xs text-muted-foreground leading-normal">
                  서로 다른 두 사이트의 배당 차이를 이용해 무위험 수익을 내는 양방 베팅 금액 비율을 산출합니다.
                </p>
              </div>
            </div>
            ...
            <div className="glass-card-hover rounded-2xl p-5 flex items-start gap-4 cursor-pointer group">
              ...
              <div>
                <h4 className="font-bold text-sm text-foreground mb-1 group-hover:text-primary transition-colors flex items-center gap-1">
                  베팅 계산기 <ChevronRight className="w-3.5 h-3.5 opacity-0 group-hover:opacity-100 transition-all" />
                </h4>
                <p className="text-xs text-muted-foreground leading-normal">
                  다양한 베팅 유형(싱글, 멀티, 시스템)에 따라 배당률과 금액을 대입하여 기대 총액을 미리 계산합니다.
                </p>
              </div>
            </div>
            ...
            <div className="glass-card-hover rounded-2xl p-5 flex items-start gap-4 cursor-pointer group">
              ...
              <div>
                <h4 className="font-bold text-sm text-foreground mb-1 group-hover:text-primary transition-colors flex items-center gap-1">
                  배당률 변환 계산기 <ChevronRight className="w-3.5 h-3.5 opacity-0 group-hover:opacity-100 transition-all" />
                </h4>
                <p className="text-xs text-muted-foreground leading-normal">
                  미국식, 소수식, 분수식 및 확률값을 실시간으로 양방향 변환하여 직관적으로 확인합니다.
                </p>
              </div>
            </div>
